...
export interface NetworkVisParams {
  type: 'table';
  showLabels: boolean;
  showPopup: boolean;
  ...
  return (
    <div>
      ...
      <EuiPanel paddingSize="s">
        ...
        <SwitchOption
          label={i18n.translate('visTypeNetwork.params.showLabels', {
        ...
        <SwitchOption
          label={i18n.translate('visTypeNetwork.params.showPopup', {
        ...
        <SwitchOption
          label={i18n.translate('visTypeNetwork.params.showColorLegend', {
        ...
        <SwitchOption
          label={i18n.translate('visTypeNetwork.params.nodePhysics', {
        ...
        <EuiFormRow
          ...
          label={
            <FormattedMessage
              id="visTypeNetwork.params.firstNodeColor"
        ...
        <EuiFormRow
          ...
          label={
            <FormattedMessage
              id="visTypeNetwork.params.secondNodeColor"
        ...
        <EuiFormRow
          ...
          label={
            <FormattedMessage
              id="visTypeNetwork.params.labelColor"
...
export { NetworkOptions as default };
